...
ruta_remota = 'GARCIAPEREZ.xlsx'  # El archivo que subiste previamente

# Ruta local dentro de Replit (guardamos el archivo en el directorio actual)
ruta_local = 'GARCIAPEREZ.xlsx'
...
def download_file():
    ...
    if ruta_local:
        ...
        return send_file(
            ...
            download_name=
            'GARCIAPEREZ.xlsx',  # Nombre del archivo descargado en el navegador
            mimetype=
